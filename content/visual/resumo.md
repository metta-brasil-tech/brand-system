...
### 4.3 Fallback — Zalando Sans Expanded (atualizado 2026-05-12) (mesma lógica)

Quando a plataforma não suporta SF Pro (Google Slides, Canva, editores web sem @font-face custom), usar **Zalando Sans Expanded** — também fonte variável compatível, eixos equivalentes.

| Eixo Zalando Sans Expanded | Range | Equivalência com SF Pro |
|------------------|-------|------------------------|
| `wght` | 100-1000 | Mesmos valores (270, 400, 410, 510, 540, 590, 650, 700, 870) |
| `wdth` | 25-151 | Usar **132** para Expanded, **100** para Regular |
| `opsz` | 8-144 | Usar `auto` |
...
- ...todas as 11 variações mapeiam 1:1.
...
**Fontes PROIBIDAS como fallback**: Inter, Arial, Helvetica, Open Sans, qualquer outra. Apenas SF Pro Variable (primária) e Zalando Sans Expanded (fallback).
