...
def build_metta_yellow_bloco(briefing: dict, copy: dict, image_url: str | None) -> dict:
    ...
    # 5) Body — SF Pro Regular 26px sentence (texto/desenvolvimento, menor que sub)
    if body:
        elements.append({
            "type": "text",
            "slot_name": "body",
...
def build_metta_a_headline_foto_dark(briefing: dict, copy: dict, image_url: str | None) -> dict:
    ...
    # 4) Subheadline + body (acima do CTA, coluna esquerda) — ambos SF Pro Regular
    text_block_y = H - 340
    if subhead:
        elements.append({
            "type": "text",
            ...
            "font": {
                ...
                "weight": 400, "stretch_pct": 100, "size": 30,
                "line_height_pct": 125, "letter_spacing_pct": -0.3,
                "text_case": "sentence",
            },
            "color": "#FFFFFF",
            "align": "left",
    ...
    if body:
        elements.append({
            ...
            "font": {
                "family": "SF Pro", "style": "Regular",
                "weight": 400, "stretch_pct": 100, "size": 24,
                "line_height_pct": 135, "letter_spacing_pct": -0.2,
                "text_case": "sentence",
            },
            "color": "#B0CAD8",
            "align": "left",
...
def build_metta_d_fullbleed(briefing: dict, copy: dict, image_url: str | None) -> dict:
    ...
    # 4) Body — SF Pro Regular sentence, menor
    if body:
        elements.append({
            "type": "text",
            "slot_name": "body",
...
def build_metta_yellow_editorial(briefing: dict, copy: dict, image_url: str | None) -> dict:
    ...
    if subhead:
        elements.append({
            ...
            "font": {
                "family": "SF Pro", "style": "Regular",
                "weight": 400, "stretch_pct": 100, "size": 38,
                "line_height_pct": 125, "letter_spacing_pct": -0.3,
                "text_case": "sentence",
            },
            "color": "#FFFFFF",
    ...
    # 3) Body — SF Pro Regular sentence menor (texto/desenvolvimento)
    if body:
        elements.append({
            "type": "text",
            "slot_name": "body",
            ...
            "font": {
                "family": "SF Pro", "style": "Regular",
                "weight": 400, "stretch_pct": 100, "size": 26,
                "line_height_pct": 135, "letter_spacing_pct": -0.2,
                "text_case": "sentence",
            },
            "color": "#B0CAD8",
...
def build_metta_news_card(briefing: dict, copy: dict, image_url: str | None) -> dict:
    ...
    # 4) Subheadline + body — entre headline e foto (ambos SF Pro Regular)
